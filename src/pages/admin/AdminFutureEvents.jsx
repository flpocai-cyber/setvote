...
import {
    ...
    Users, UserCircle, BarChart2, Share2, CalendarDays,
...
const AdminFutureEvents = () => {
    ...
    const handleCreateEvent = async (e) => {
        ...
        if (!formTitle || !formDate || !formTime) {
            alert('Preencha pelo menos o título, data e hora do evento.')
            return
        }
        ...
        <div className="min-h-screen bg-charcoal-950 flex">
            ...
            <aside className="w-64 bg-charcoal-900 border-r border-charcoal-800 flex flex-col hidden lg:flex">
                ...
                <nav className="flex-1 px-4 space-y-2">
                    ...
                    {sidebarLink('/admin/estatisticas', <BarChart2 size={20} />, 'Estatísticas')}
                    {sidebarLink('/admin/link-musicos', <Share2 size={20} />, 'Link para Músicos')}
                    {sidebarLink('/admin/eventos-futuros', <CalendarDays size={20} />, 'Eventos Futuros', true)}
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center justify-between mb-10">
                        <div>
                            ...
                            <p className="text-charcoal-400 mt-2">Crie links para o público e contratantes votarem nas músicas antes do show.</p>
                        </div>
                        <button
                    ...
                    {loading ? (
                        ...
                        <div className="glass rounded-3xl border border-dashed border-charcoal-700 p-16 flex flex-col items-center justify-center text-center">
                            <CalendarPlus className="text-charcoal-700 mb-4" size={48} />
                            <h3 className="text-xl font-display text-charcoal-500">Nenhum evento futuro</h3>
                            <p className="text-charcoal-600 text-sm mt-2">Clique em "Novo Evento" para agendar seu primeiro show futuro.</p>
                        </div>
                    ) : (
                        <div className="space-y-4">
                            {events.map((event) => (
                                <motion.div
                                    key={event.id}
                                    layout
                                    className={`glass rounded-2xl border p-5 sm:flex items-center gap-6 ${event.is_active ? 'border-gold-500/30' : 'border-charcoal-800/50 opacity-70'}`}
                                >
                                    <div className="flex-1 mb-4 sm:mb-0">
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-sm text-charcoal-400">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button
                                            ...
                                            className={`p-2.5 rounded-xl transition-colors ${event.is_active ? 'bg-charcoal-800 text-green-500 hover:bg-charcoal-700' : 'bg-charcoal-800 text-charcoal-500 hover:bg-charcoal-700'}`}
                                            title={event.is_active ? "Desativar Votação" : "Ativar Votação"}
                                        >
                                        ...
                                        <button
                                            ...
                                            className="p-2.5 bg-charcoal-800 text-charcoal-500 hover:text-red-400 hover:bg-charcoal-700 rounded-xl transition-colors"
